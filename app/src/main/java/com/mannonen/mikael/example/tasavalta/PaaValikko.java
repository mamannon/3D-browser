...
public class PaaValikko extends Fragment {
    ...
    public ToggleButton getGraphics() {
        return mGraphics;
    }

    public Muisti getMuisti() {
        return mMuisti;
    }
    ...
    class VakioNappi implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            {
                case 2001:
                    ToggleButton siirto1=(ToggleButton) v;
                    if (siirto1.isChecked()) {

                        //käyttäjä haluaa englantia
                        mSing.mAktiviteetti1.mEnglanti=true;
                    } else {

                        //käyttäjä haluaa suomea
                        mSing.mAktiviteetti1.mEnglanti=false;
                    }
                    break;
                case 2002:
                    ToggleButton siirto2=(ToggleButton) v;
                    if (siirto2.isChecked()) {
    ...
    class CADNappi implements View.OnClickListener {
        ...
        private void asetaLandscape() {
            ...
            if (mSing.mAktiviteetti1.mFragmentti2!=null) {
                ...
                frag = mSing.mAktiviteetti1.mFragmentti2;
                tag = "fragmentti2";
            } else {
                siirto = mSing.mAktiviteetti1.mFragmentti1.annaNakyma();
                frag = mSing.mAktiviteetti1.mFragmentti1;
                tag = "fragmentti1";
            }
...
//                if (!siirto.isVisible()) {
                if (null==siirto.annaNakyma().getParent()) {
                    FragmentTransaction fragmentTransaction=
                            mSing.mAktiviteetti1.mFragmentManager.beginTransaction();
                    fragmentTransaction.replace(R.id.sisaltoVasen, siirto, "fragmentti3");
                    fragmentTransaction.disallowAddToBackStack();
                    fragmentTransaction.commit();
                ...
                fragmentTransaction.replace(R.id.sisaltoVasen, mSing.mAktiviteetti1.mFragmentti3,
                        "fragmentti3");
                fragmentTransaction.disallowAddToBackStack();
                fragmentTransaction.commit();
            }
    ...
    class TekstiNappi implements View.OnClickListener {
        ...
        private void asetaLandscape() {
            ...
            if (mSing.mAktiviteetti1.mFragmentti3!=null) {
                ...
                frag = mSing.mAktiviteetti1.mFragmentti3;
                tag = "fragmentti3";
            } else {
                siirto = mSing.mAktiviteetti1.mFragmentti1.annaNakyma();
                frag = mSing.mAktiviteetti1.mFragmentti1;
...
//                            mFragmentti3=(CADRuutu) luoUudestaan(mFragmentti3);
        ...
        public void onClick(View v) {
            ...
            if (mSing.mAktiviteetti1.mEnglanti==true) {
                mSing.mAktiviteetti1.mTekstiTiedosto = mTiedostoNimet[tag] + ".eng";
            } else {
                mSing.mAktiviteetti1.mTekstiTiedosto = mTiedostoNimet[tag] + ".fin";
            }
            ...
            if (siirto != null) {
                ...
                if (null==siirto.annaNakyma().getParent()) {
                    ...
                    FragmentTransaction fragmentTransaction=
                            mSing.mAktiviteetti1.mFragmentManager.beginTransaction();
                    fragmentTransaction.replace(R.id.sisaltoVasen, siirto, "fragmentti2");
                    fragmentTransaction.disallowAddToBackStack();
                    fragmentTransaction.commit();
                ...
                fragmentTransaction.replace(R.id.sisaltoVasen, mSing.mAktiviteetti1.mFragmentti2,
                        "fragmentti2");
                fragmentTransaction.disallowAddToBackStack();
                fragmentTransaction.commit();
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSing=annaIlmentyma();
        mSing.mAktiviteetti1.mFragmentti1=this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        //Aktivoidaan tiedot kovalevyltä, jos jotain on olemassa ja se on tarpeen
        if (mMuisti==null) {
            String polku = getActivity().getApplicationContext().getFilesDir().getAbsolutePath();
            ...
            try {
                ...
                mMuisti = new Muisti(getActivity().getApplicationContext());
            }
        }
        ...
        int versio;
        try {
            String packageVersion = getActivity().getApplicationContext().getPackageName();
            versio = getActivity().getApplicationContext().getPackageManager().
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (mSing.mAktiviteetti1.mEnglanti) {
        ...
        if (!mSing.mAktiviteetti1.eiValaisua && mMuisti.annaOptio()==2) {
            mGraphics.setChecked(true);
            if (!mSing.mAktiviteetti1.mOnkoValittuHienoGrafiikka) {
                mGraphics.setChecked(false);
            }
        } else {
            mGraphics.setChecked(false);
            if (mSing.mAktiviteetti1.mOnkoValittuHienoGrafiikka && mMuisti.annaOptio()==2) {
                mGraphics.setChecked(true);
            }
        }
    ...
    public void tuoEsille(String nimi, char tyyppi) {
        ...
        //varmistetaan, ettei teksti ole null
        if (nimi==null) return;
