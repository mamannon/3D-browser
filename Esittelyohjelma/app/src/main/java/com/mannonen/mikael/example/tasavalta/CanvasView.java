...
public class CanvasView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public int luoFontti() {
        ...
        if (!familyName.contains("EI_OLE")) {
            ...
            } else if (mRenki.mPitchAndFamily == 1 || mRenki.mPitchAndFamily == 8) {
                tf = Typeface.MONOSPACE;
            } else if (mRenki.mWeight == 100 || mRenki.mWeight == 200 || mRenki.mWeight == 300 ||
        ...
        if (mRenki.mPitchAndFamily == 32) {
            tf = Typeface.SANS_SERIF;
        } else if (mRenki.mPitchAndFamily == 16) {
            tf = Typeface.SERIF;
        } else if (mRenki.mPitchAndFamily == 1 || mRenki.mPitchAndFamily == 8) {
            tf = Typeface.MONOSPACE;
        } else {
