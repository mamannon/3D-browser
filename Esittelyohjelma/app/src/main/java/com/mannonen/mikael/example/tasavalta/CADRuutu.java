...
public class CADRuutu extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //pyydetään singelton luokan ilmentymä
        mSing=annaIlmentyma();

        //tämä tarvitaan tulostamiseen liittyvän epäkohdan vuoksi
        mSing.mAktiviteetti1.mViimeinen=1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        //tämä siltä varalta, että Kirjasto1 puuttuu laitteesta
        if (!onkoKirjasto1Ladattu) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        //OpenGL ES pitäisi olla käytettävissä
        avaaCAD();
    }
    ...
    public void avaamisenJalkeen() {
        ...
        //kytketään nappulat tilanteen mukaiseen asentoon
...
*/
    private void valintaListaClick() {
        ...
        mValintaLista=new ValintaLista();
        mValintaLista.show(mSing.mAktiviteetti1.mFragmentManager, "ValintaLista");
    }
    ...
    private void tulostettu(String nimi) {

        if (nimi!=null) {

            //lisätään nimen perään juokseva numero
            nimi = nimi + "_" + mJuoksevaNumero.toString();
            mJuoksevaNumero++;

            //muutetaan Kirjasto1:n luoma bitmap JPG tiedostoksi. Tallennetaan tiedosto images
            // kansioon
            ...
            final Runnable r=new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        //jotta käyttäjä pääsisi helpommin käsiksi pdf-tiedostoon, kopioidaan
                        // se sähköpostiin
    ...
    public void paivitaAla() {
        ...
        //määritetään OpenGL näkymän täsmällinen koko. Tämän jälkeen saatetaan määrittää täsmällinen
        //koko
